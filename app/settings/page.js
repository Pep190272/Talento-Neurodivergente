  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 8px 32px rgba(4, 107, 210, 0.3)'
      }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <FaKey style={{ fontSize: '4rem', color: '#046BD2', marginBottom: '1rem' }} />
          <h1 style={{
            color: '#fff',
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <input
            ...
            style={{
              ...
              border: '2px solid rgba(4, 107, 210, 0.3)',
              borderRadius: '12px',
              color: '#fff',
              fontSize: '1rem',
              outline: 'none',
            ...
            onFocus={(e) => e.target.style.border = '2px solid #046BD2'}
            onBlur={(e) => e.target.style.border = '2px solid rgba(4, 107, 210, 0.3)'}
          />
        </div>
        ...
        <button
          ...
          style={{
            width: '100%',
            padding: '1.2rem',
            background: saved ? '#4ade80' : 'linear-gradient(135deg, #046BD2 0%, #046BD2 100%)',
            border: 'none',
            borderRadius: '12px',
            color: '#fff',
            fontSize: '1.2rem',
            ...
            gap: '0.5rem',
            transition: 'all 0.3s',
            boxShadow: '0 4px 12px rgba(4, 107, 210, 0.4)'
          }}
        >
          {saved ? (
            <>
        ...
        <div style={{
          ...
          <h3 style={{ color: '#046BD2', marginBottom: '0.5rem', fontFamily: 'Orbitron, sans-serif' }}>
            ¿Cómo obtener tu clave API?
          </h3>
          <ol style={{ color: '#ccc', lineHeight: 1.8, paddingLeft: '1.5rem' }}>
            <li>Visita <a href="https://platform.openai.com/api-keys" target="_blank" style={{ color: '#046BD2' }}>platform.openai.com/api-keys</a></li>
